public class Grille {
     ...
     * @param nbrPiecesX Nombre de pi�ces horizontalement.
     * @param nbrPiecesY Nombre de pi�ces verticalement.
     * @param largeurPiece Largeur des pi�ces.
     * @param hauteurPiece Hauteur des pi�ces.
     * @param nbrNonKitten Nombre d'objets non-kitten qui sont distribu�s.
     */
    ...
    /**
     * M�thode qui donne une case vide al�atoire sur la grille.
     * @return Retourne une case vide al�toire.
     */
